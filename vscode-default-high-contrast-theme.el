...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:background "#000" :foreground "#002b36" :distant-foreground "#002b36" :inverse-video t :box (:line-width 1 :color ,vs-orange)))))
   ...
   `(region ((t (:background "#000" :foreground ,vs-bg))))
   ...
   `(tool-bar ((t (:background "#000" :foreground ,vs-bg :box (:line-width 1 :style released-button)))))
