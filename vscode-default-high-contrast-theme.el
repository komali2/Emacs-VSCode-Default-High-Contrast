...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:background "#fff" :foreground "#002b36" :distant-foreground "#002b36" :inverse-video t :box (:line-width 1 :color ,vs-orange)))))
   ...
   `(header-line ((t (:underline (:color ,vs-lightblue :style line) :overline nil :box (:line-width 1 :color ,vs-fg :style unspecified) :foreground ,vs-fg :background ,vs-bg))))
   ...
   `(mode-line-buffer-id ((t (:background ,vs-bg :foreground ,vs-fg  :weight bold :overline ,vs-orange :underline ,vs-orange :box (:line-width 1 :color ,vs-orange)))))
   ...
   `(lazy-highlight ((t (:box (:line-width 1 :color ,vs-orange)))))
   ...
   `(mu4e-header-highlight-face ((t (:box (:line-width 1 :color ,vs-orange)))))
