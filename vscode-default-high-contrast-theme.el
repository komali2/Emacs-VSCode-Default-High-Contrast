...
(let* (
       ...
       (vs-orange "#f38518")
       (vs-palegreen                "#7ca668")
       (vs-lightgreen                "#dcdcaa")
       (vs-forestgreen                "#859900")
       (vs-brightblue                "#268bd2")
       (vs-lightblue                "#9cdcfe")
       (vs-turqoise                "#4ec9b0")
       (vs-purple                "#b180d7")
       (vs-lightred                "#dbaba7")
  ...
  (custom-theme-set-faces
   ...
   '(default ((t (:inherit nil :stipple nil :background 'vs-bg :foreground "white" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :foundry "PfEd" :family "DejaVu Sans Mono"))))
   '(cursor ((t (:background "#fff" :foreground "#002b36" :distant-foreground "#002b36" :inverse-video t :box (:line-width 1 :color "#f38518")))))
   '(fixed-pitch ((t (:family "Monospace"))))
   '(variable-pitch ((((type w32)) (:foundry "outline" :family "Arial")) (t (:family "Sans Serif"))))
   '(escape-glyph ((t (:foreground "#6c71c4"))))
   '(homoglyph ((((background dark)) (:foreground "cyan")) (((type pc)) (:foreground "magenta")) (t (:foreground "brown"))))
   '(minibuffer-prompt ((t (:foreground "#839496" :background 'vs-bg))))
   '(highlight ((t (:background "#073642"))))
   '(region ((t (:background "#fff" :foreground 'vs-bg))))
   '(shadow ((t (:foreground "#586e75"))))
   '(secondary-selection ((t (:background "#073642")))) '(trailing-whitespace ((t (:background "#7ca668"))))
   ...
   '(fringe ((t ( :foreground 'vs-fg :background 'vs-bg :box (:line-width 1 :color "#9CDCFE")))))
   '(header-line ((t (:underline (:color "#f38518" :style line) :overline nil :box (:line-width 1 :color "#f38518" :style unspecified) :foreground 'vs-fg :background 'vs-bg))))
   '(tooltip ((t (:foreground "#DEB542" :background "#7B6000" :inherit (variable-pitch)))))
   '(mode-line ((t (:background 'vs-bg :foreground "#fff"  :overline "#9CDCFE" :underline "#9CDCFE"))))
   '(mode-line-inactive ((t (:background 'vs-bg :foreground "#fff"  :overline "#9CDCFE" :underline "#9CDCFE"))))
   '(mode-line-buffer-id ((t (:background 'vs-bg :foreground 'vs-fg  :weight bold :overline "#f38518" :underline "#f38518" :box (:line-width 1 :color "#f38518")))))
   '(mode-line-buffer-id-inactive ((t (:background 'vs-bg :foreground 'vs-fg :weight bold ))))
   '(mode-line-emphasis ((t (:weight bold))))
   '(mode-line-highlight ((((class color) (min-colors 88)) (:box (:line-width 2 :color "grey40" :style released-button))) (t (:inherit (highlight)))))
   '(isearch ((t (:weight normal :box (:line-width 2 :color "#f38518") :foreground 'vs-bg :background "#848484"))))
   ...
   '(hl-line ((t (:background 'vs-bg :box (:line-width 1 :color "#f38518")))))
   ...
   '(tool-bar ((t (:background "#fff" :foreground 'vs-bg :box (:line-width 1 :style released-button)))))
   ...
   '(org-agenda-date-today ((t (:box (:line-width 2 :color 'vs-fg :style released-button)))))
